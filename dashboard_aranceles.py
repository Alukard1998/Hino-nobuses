...
with sim_kpi_col4:
    st.markdown(f"""
    <div class='metric-card'>
        <div class='metric-label'>Simulated Market Share</div>
        <div class='metric-value-green'>{hino_sim_share:.1f}%</div>
        <div style='color: #16a34a; font-size: 0.75rem;'>Compared to {hino_real_share:.1f}% actual share</div>
    </div>
    """, unsafe_allow_html=True)
